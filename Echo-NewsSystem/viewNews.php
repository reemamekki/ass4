...
<title>Echo News - All News</title>
<style>
...
<table>
    ...
    if($result->num_rows > 0){
        while($row = $result->fetch_assoc()){
            ...
            echo "<td>
                    <a class='button' href='editNewsUi.php?id=".$row['id']."'>Edit</a>
                    <a class='button' style='margin-left:5px;' href='deletedNews.php?id=".$row['id']."'>Delete</a>
                  </td>";
            echo "</tr>";
        }
    } else {
        echo "<tr><td colspan='6' style='text-align:center;'>No news found.</td></tr>";
    }
    ?>
</table>
